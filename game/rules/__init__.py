...
from game.rules.competition import (
    find_rival, start_fight, roll_fight, resolve_fight,
    is_fight_rolled, pending_roller, fight_winner, fight_outcome,
)
from game.rules.turn import play_turn, end_turn
